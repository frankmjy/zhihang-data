...
if (-not (Test-Path -LiteralPath $EnvPath)) {
  ...
  @(
    ...
    'FEISHU_NOTIFY_CHAT_ID=oc_3bc648b9b761f24a65366a9b04b32eb2',
    'FEISHU_NOTIFY_CHAT_NAME=',
    'EXTRA_ABNORMAL_NOTIFY_ENABLED=true',
    'EXTRA_ABNORMAL_NOTIFY_CHAT_ID=oc_3bc648b9b761f24a65366a9b04b32eb2',
    ...
    'CHANGE_FEISHU_NOTIFY_CHAT_ID=oc_3bc648b9b761f24a65366a9b04b32eb2',
    'CHANGE_FEISHU_NOTIFY_CHAT_NAME=',
    'EVENT_FEISHU_APP_ID=',
    'EVENT_FEISHU_APP_SECRET=',
    'EVENT_FEISHU_BITABLE_APP_TOKEN=',
    'EVENT_FEISHU_TABLE_ID=',
    'EVENT_FEISHU_VIEW_ID=',
    'EVENT_FEISHU_NOTIFY_CHAT_ID=oc_3bc648b9b761f24a65366a9b04b32eb2',
    ...
    'INSPECT_FEISHU_NOTIFY_CHAT_ID=oc_3bc648b9b761f24a65366a9b04b32eb2',
